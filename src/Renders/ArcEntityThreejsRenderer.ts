...
export class ArcEntityThreejsRenderer {
  ...
  public static render(arcData: ArcData, scene: THREE.Scene): THREE.Object3D | null {
  ...
  public static renderMultiple(arcDataList: ArcData[], scene: THREE.Scene): THREE.Object3D[] {
